...
<div class="content">	
	<header><h1>Accuiel</h1>
		<div id="twitter">
          <img src="images/user.png"  name="photo" style="border-radius: 30px;  width: 50px;height: 50px;">
         <?php   
   ...
   if ($resultcheck > 0) {
    ...
    ?>
         ...
         <div class="mg">
			<img src="images/YUI.PNG" style="margin-right: 20px"><img src="images/cds.png" style="margin-right: 20px"><img src="images/jhSans titre.png" style="margin-right: 20px"><img src="images/fceSans titre.png" style="margin-right: 20px"><img src="images/45Sans titre.png" style="margin-right: 20px" width="15%">
...
<?php   
   ...
   if ($resultcheck > 0) {
	...
	<article>
		<div class="hat">
	<center><h3>Bienvenue <span style="color: #a56336;"><?php echo $_SESSION['nom']?></span> sur <p style="color: #DEB887;">"Talk With Us"</p> On vous souhaite une experience exceptionnel</h3></center>
	<p><center>C'est le meilleur endroit pour communiquez avec des personnes qui partagent les meme interessent que vous..Allez <span style="color: #DEB887;"> <?php echo $_SESSION['nom']?></span> n'hesitez pas a demarer votre premier partage</center></p>
 </div>
 </article>
</div>
</div>
